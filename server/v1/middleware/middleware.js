...
class Middleware {
  ...
  static adminAuth(req, res, next) {
    if (req.payload.isAdmin) next();
      ...
      Helpers.sendError(res, 403, 'This request requires Administrator privileges');
    }
  }
  ...
  static validateParams(req, res, next) {
    ...
    if (recordID && (isNaN(recordID) || Number(recordID) > 10000))
      Helpers.sendError(res, 400, 'Invalid parameters');
    else next();
  }
